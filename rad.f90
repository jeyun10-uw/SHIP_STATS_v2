...
! Tak Yamaguchi 2015/10: RADAEROS
	...
	REAL(KIND=kind_rb), DIMENSION(:,:), ALLOCATABLE, SAVE :: &
        ...
        !3-D radiation stream arrays to be passed to statistics.f90 for
        !conditional averaging
        real(KIND=kind_rb), dimension(:,:,:), allocatable, save :: swUp3D, swDown3D, lwUp3D, lwDown3D
        logical, save :: isAllocatedRadStreams = .false.
